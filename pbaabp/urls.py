...
urlpatterns = [
    ...
    path("email-draft/", email_draft, name="email_draft"),
    path("email-draft/preview/", email_draft_preview, name="email_draft_preview"),
    path("email-draft/image/<str:filename>", email_draft_image, name="email_draft_image"),
